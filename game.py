# game.py (ВЕРСІЯ 16.0 - ЗОЛОТІ ЗАГОЛОВКИ)
...
[data-testid="stHeading"] {{
    ...
    text-shadow: 
        ...
        -2px  2px 0 #000,
         2px  2px 0 #000,
         -3px -3px 8px rgba(0,0,0,0.7); /* Додаткова м'яка тінь для об'єму */
}}
